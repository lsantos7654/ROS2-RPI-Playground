...
{
public:
  explicit Init_LEDToggle_Request_toggle(::rpi_gpio_msgs::srv::LEDToggle_Request & msg)
  : msg_(msg)
  {}
...
class Init_LEDToggle_Request_gpiochoice
{
public:
  Init_LEDToggle_Request_gpiochoice()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LEDToggle_Request_toggle gpiochoice(::rpi_gpio_msgs::srv::LEDToggle_Request::_gpiochoice_type arg)
  {
    msg_.gpiochoice = std::move(arg);
    return Init_LEDToggle_Request_toggle(msg_);
  }
...
{
  return rpi_gpio_msgs::srv::builder::Init_LEDToggle_Request_gpiochoice();
}
